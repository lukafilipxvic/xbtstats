document.addEventListener('DOMContentLoaded', function () {
    ...
    var selectedCoin = coinSelect.value; // default selection

    coinSelect.addEventListener('change', () => {
        var selectedCoin = coinSelect.value;

        d3.csv(`https://community-api.coinmetrics.io/v4/timeseries/asset-metrics?assets=${selectedCoin}&metrics=PriceUSD,AdrBalNtv1Cnt,AdrBalNtv10Cnt,AdrBalNtv100Cnt,AdrBalNtv1KCnt,AdrBalNtv10KCnt,AdrBalNtv100KCnt&page_size=10000&pretty=true&format=csv`, function (err, rows) {
            ...
            var min_10_count = {
                type: "scatter",
                mode: "lines",
                name: "Addresses with Balance > 10",
                x: unpack(rows, "time"),
            ...
            var min_100_count = {
                type: "scatter",
                mode: "lines",
                name: "Addresses with Balance > 100",
                x: unpack(rows, "time"),
            ...
            var min_1k_count = {
                type: "scatter",
                mode: "lines",
                name: "Addresses with Balance > 1k",
                x: unpack(rows, "time"),
            ...
            var min_10k_count = {
                type: "scatter",
                mode: "lines",
                name: "Addresses with Balance > 10k",
                x: unpack(rows, "time"),
            ...
            var min_100k_count = {
                type: "scatter",
                mode: "lines",
                name: "Addresses with Balance > 100k",
                x: unpack(rows, "time"),
